...
module.exports = {
  seasonToEnumQuery               : seasonToEnumQuery,
  createGamesIndexQuery           : createGamesIndexQuery,
  createEventsIndexQuery          : createEventsIndexQuery,
  createSportsIndexQuery          : createSportsIndexQuery,
  createAthletesIndexQuery        : createAthletesIndexQuery,
  dropGamesIndex                  : dropGamesIndex,
  dropSportsIndex                 : dropSportsIndex,
  dropEventsIndex                 : dropEventsIndex,
  ...
  fillGamesQuery                  : fillGamesQuery,
  fillAthletesQuery               : fillAthletesQuery,
  fillResulsQuery                 : fillResulsQuery,
